<?php
  ...
  $tourneyID = "test20110530"; /* The tournament ID. (e.g., mcfoot20110811, mcbask20110409, etc.) */

  $primaryTitle = "Another Test"; /* States the sport (e.g., Pro Football, College Football, Pro Baseball, etc. */
  $secondaryTitle = "Test Secondary"; /* Generally says something like Week 1, Week 2, Round of 16, etc. */
  $tertiaryTitle = "Test Tertiary"; /* This is a good place to specify the time period of the games in the pick set. */
  $picksetName = "Pickset Name"; /* The name of the pick set, for the header. (e.g. "Pro Football - 2011 Preseason Week 1") */

  $tabClick1 = "Tabclick"; /* The titles of the dropdown tabs on the form. Some of these variables may be unnecessary. */
  $tabClick2 = "";
  $tabClick3 = "";
  $tabClick4 = "";

  $game1_teamA = "Philadelphia"; /* The names of the teams competing. */
  $game1_teamB = "Dallas";
