<?php
  ...
  do_header("Men's College Basketball Results - March 24, 2011 - MadSwag");
...
?>
      <div class = 'oneCol'>
        ...
        <h3 class = "center">Men's College Basketball | Round of Sixteen</h3>
        <?php
          //connect to database
          $db = do_connect_to_database();
          
          //define the variable with the name of the template table
          $table = "m_c_bball_roundof16_2011_scores";
      ...
      <div class = 'comments'>
        <script src="http://connect.facebook.net/en_US/all.js#xfbml=1"></script><fb:comments href="http://www.madswag.com/mcbask20110324.php" num_posts="10" width="500"></fb:comments>
      </div>
<?php
  do_footer();
?>