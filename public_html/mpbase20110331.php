<?php
  ...
  do_header("Baseball Opening Day Results - March 31st-April 1st, 2011 - MadSwag");
...
?>
      <div class = 'oneCol'>
        ...
        <h3 class = "center">Baseball Opening Day, 2011</h3>
        <?php
          //connect to database
      ...
      <div class = 'comments'>
        <script src="http://connect.facebook.net/en_US/all.js#xfbml=1"></script><fb:comments href="http://www.madswag.com/mpbase20110331.php" num_posts="10" width="500"></fb:comments>
      </div>
<?php
  do_footer();
?>