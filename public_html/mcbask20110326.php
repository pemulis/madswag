<?php
  ...
  do_header("Men's College Basketball - March 26, 2011 - MadSwag");
...
?>
      <div class = 'oneCol'>
        ...
        <h3 class = "center">Men's College Basketball | Round of Eight, 2011</h3>
        <?php
          //connect to database
          $db = do_connect_to_database();
          
          //define the variable with the name of the template table
          $table = "m_c_bball_roundof8_2011_scores";
      ...
      <div class = 'comments'>
        <script src="http://connect.facebook.net/en_US/all.js#xfbml=1"></script><fb:comments href="http://www.madswag.com/mcbask20110326.php" num_posts="10" width="500"></fb:comments>
      </div>
<?php
  do_footer();
?>