<?php
  ...
  do_header("Men's College Basketball Results - 2011-03-19 - MadSwag");
...
?>
      <div class = 'oneCol'>
        ...
        <h3 class = "center">Men's College Basketball Tournament - Second Round, 2011</h3>
        <?php
          //connect to database
      ...
      <div class = 'comments'>
        <script src="http://connect.facebook.net/en_US/all.js#xfbml=1"></script><fb:comments href="http://www.madswag.com/mcbask20110317.php" num_posts="10" width="500"></fb:comments>
      </div>
<?php
  do_footer();
?>