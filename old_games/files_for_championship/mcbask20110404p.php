...
?>
      <div id = "oneCol">
        <?php
          ...
          $table = "m_c_bball_championship_2011";
          ...
          //template: use only as many as you need
          $mailContent =  "These are your current picks for the 2011 men's college basketball championship game.\n\n".
                          "$winner1: Win by $spread1 points\n\n".
                          "You can change your picks at any time before 9:23pm EST on April 4th. Just go back to the form on the game page and enter your new picks.\n\n".
                          "Good luck,\n".
                          "The MadSwag Team";
          ...
          generate_picks_accepted("9:23pm EST on April 4th");
          $db->close();
        ?>
      </div>
<?php
