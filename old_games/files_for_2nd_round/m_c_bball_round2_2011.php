<?php
  ...
  do_header("Men's College Basketball Championship Tournament: Round 2 - MadSwag");
...
?>
      <div id = "oneCol">
        <?php
          ...
          $mailContent =  "These are your current picks for round two of the 2011 men's college basketball tournament.\n\n".
                          ...
                          "You can change your picks at any time before tipoff on March 17. Just go back to the form on the game page and enter your new picks.\n\n".
                          "Good luck,\n".
                          "The MadSwag Team";
          ...
          generate_picks_accepted("tipoff on March 17");
          $db->close();
        ?>
      </div>
<?php
