...
?>
      <div id = "oneCol">
        <?php
          ...
          try
          {
            if (!$winner1 || !$winner2 || !$winner3 || !$winner4 || !$winner5 || !$winner6 || !$winner7 || !$winner8 || !$winner9 || !$winner10 || !$winner11 || !$winner12 || !$winner13 || !$winner14 || !$winner15)
            {
          ...
          if ($numRows > 0)
          {
            ...
            update_picks_fifteen($db, $userID, $table, $winner1, $spread1, $winner2, $spread2, $winner3, $spread3, $winner4, $spread4, $winner5, $spread5, $winner6, $spread6, $winner7, $spread7, $winner8, $spread8, $winner9, $spread9, $winner10, $spread10, $winner11, $spread11, $winner12, $spread12, $winner13, $spread13, $winner14, $spread14, $winner15, $spread15);
          } else {
            //if $numRows is not greater than 0, the user has not made packs, so insert their picks into the table
            //template: use only as many as you need - you will likely have to use a different function
            insert_picks_fifteen($db, $userID, $table, $winner1, $spread1, $winner2, $spread2, $winner3, $spread3, $winner4, $spread4, $winner5, $spread5, $winner6, $spread6, $winner7, $spread7, $winner8, $spread8, $winner9, $spread9, $winner10, $spread10, $winner11, $spread11, $winner12, $spread12, $winner13, $spread13, $winner14, $spread14, $winner15, $spread15);
          }
          ...
          //template: use only as many as you need
          $mailContent =  "These are your current picks for Opening Day, 2011.\n\n".
                          ...
                          "You can change your picks at any time before 1:05pm EST on March 31st. Just go back to the form on the game page and enter your new picks.\n\n".
                          "Good luck,\n".
                          "The MadSwag Team";
          ...
          generate_picks_accepted("1:05pm EST on March 31st");
          $db->close();
        ?>
      </div>
<?php
