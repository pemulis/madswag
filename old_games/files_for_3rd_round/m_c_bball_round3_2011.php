...
?>
      <div id = "oneCol">
        <?php
          ...
          $mailContent =  "These are your current picks for the third round of the 2011 men's basketball tournament.\n\n".
                          ...
                          "You can change your picks at any time before 12:15 on March 19. Just go back to the form on the game page and enter your new picks.\n\n".
                          "Good luck,\n".
                          "The MadSwag Team";
          ...
          generate_picks_accepted("12:15 on March 19");
          $db->close();
        ?>
      </div>
<?php
