...
/***
 * The purpose of this function is to generate a new Official Rules txt document for every pick set. 
 * This is necessary because of legal issues surrounding sweepstakes.
***/

// /* Test. */

// $tourneyName = "2011 Week 1 Preseason Pro Football";
// $sport = "professional football";
// $beginDate = "7pm EST on May 30th";
// $endDate = "August 15th";
// $event = "the first week of preseason games in the 2011 pro football season";
// $lockoutTime = "7pm EST on August 11th";
// $prizePool = "100";

// generate_rules($tourneyName, $sport, $beginDate, $endDate, $event, $lockoutTime, $prizePool);

// /* End Test. */

function generate_rules($tourneyName, $sport, $beginDate, $endDate, $event, $lockoutTime, $prizePool)
{
  print <<<HERE
...
<p>
  To enter the Promotion, you must first log in to MadSwag.com during the Promotion Period and complete a full entry on the $tourneyName form, and select a participating Game Host from the "Bars" section of the website. You must complete your entry and select a Game Host before the Lockout Time. (Lockout Time is described in Section 7.)
</p>
<p>
...
<p>
  The Promotion Period begins on $beginDate and ends on $endDate (or upon the completion of $event).
</p>
...
<h2>8. PRIZES.</h2>
<p>
  The approximate retail value ("ARV") of all prizes is equal to the number of Game Hosts in your Host Group multiplied by \$$prizePool, which is the amount contributed to the prize pool by each Game Host.
</p>
<p>
  Odds of winning prizes depend on the total number of eligible entries received and the relative $sport knowledge of all entrants.
</p>
